...
CAM_HEIGHT = 720
CAM_FPS = 30
MODEL_PATH = "best.pt"   # ��� path ���ŷ���ù����
CONF_THRES = 0.75       # �������D:\ai_camera\dataset㨢�鹵��
AUTO_CAPTURE_DELAY = 1.0 # �� label ������ 1 �Ԥ��¶���
...
def update_camera():
    ...
    if ret:
        ...
        global last_detect_time, already_captured
        ...
        if detected:
            set_status("Label Detected")

            if last_detect_time is None:
                last_detect_time = time.time()

            if time.time() - last_detect_time >= AUTO_CAPTURE_DELAY and not already_captured:
